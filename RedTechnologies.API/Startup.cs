...
using RedTechnologies.App.Mapper;
...
namespace RedTechnologies.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "RedTechnologies.API", Version = "v1" });
            ...
            //Show enum names on Swagger instead of int number
